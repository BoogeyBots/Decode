...
public class auto_21_spike3_red extends OpMode {
    IntakeModule intake;
    ...
    private final Pose colectare_gate = new Pose(8.2, 59, Math.toRadians(-38)).mirror();
    private final Pose colectare_gate2 = new Pose(8.2, 59, Math.toRadians(-32.5)).mirror();
    private final Pose colectare_gate3 = new Pose(8.2, 58.5, Math.toRadians(-33)).mirror();
    private final Pose cp_gate = new Pose(34.75, 57.47).mirror();
    private final Pose cp_trage_gate = new Pose(44.40, 68.77).mirror();
    private final Pose collect3 = new Pose(18.14, 35.75, Math.toRadians(0)).mirror();
    private final Pose cp_collect3 = new Pose(53.04, 31.85).mirror();
    ...
    public void buildPaths() {
        ...
        scorePreload.setLinearHeadingInterpolation(scorePose.getHeading(), collect1.getHeading());
