...
public class auto_far_red extends OpMode {
    IntakeModule intake;
    ...
    private final Pose startPose = new Pose(54.908, 10.634, Math.toRadians(90)).mirror();
    private final Pose scorePose = new Pose(54.53, 13.46, Math.toRadians(30)).mirror();
    ...
    private final Pose collect3 = new Pose(21.5, 35.52, Math.toRadians(0)).mirror();
    private final Pose cp_collect3 = new Pose(66.31, 53.04).mirror();
    private final Pose hp = new Pose(9.5, 14.5, Math.toRadians(15)).mirror();
    private final Pose hp1pe2 = new Pose(18.29, 10.66, Math.toRadians(0)).mirror();
    private final Pose hpiar = new Pose(10.83, 7.86, Math.toRadians(-15)).mirror();
    private final Pose shrek = new Pose(9.79, 37.17, Math.toRadians(-90)).mirror();
    ...
    private final Pose parcare = new Pose(39.43, 12.89).mirror();
