...
//        double turretAngle = relative_angle - currentHeading;
    ...
    public void update_red_mod() {
        double target_angle;
        if(distanta < 120) {
            target_angle = Math.toDegrees(Math.atan2(144 - currentY, 141 - currentX));
        }
        else {
            target_angle = Math.toDegrees(Math.atan2(144 - currentY, 139 - currentX));
        }
